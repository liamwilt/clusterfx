...
#define TOTAL_TIME  5       // 5 minutes 
#define CIRCLE_NUM  4       // number of circle
...
void initCircleArray(Circle circle[], int length) {
    ...
    // set  color of the lower right circle to green
    circle[3].colour[0] = 0;
    circle[3].colour[1] = 255;
    circle[3].colour[2] = 0;
    chosenCircleIndex = 3;
    currentCircle = &circle[3];
}
